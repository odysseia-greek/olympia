...
func assertTrue(a trueAssertion, trueOrFalse bool, msgAndArgs ...interface{}) error {
	var t asserter
	a(&t, trueOrFalse, msgAndArgs...)
	return t.err
}

type trueAssertion func(t assert.TestingT, trueish bool, msgAndArgs ...interface{}) bool
